...
class ListAndItemModelsTest(TestCase):
    ...
    def test_saving_and_retrieving_items(self):
        ...
        first_item = Item()
        first_item.text = 'The firts (ever) list item'
        ...
        self.assertEqual(first_saved_item.text, 'The firts (ever) list item')
...
class NewListTest(TestCase):
    ...
    def test_can_save_a_POST_request_to_an_existing_list(self):
        other_list = List.objects.create()
        correct_list = List.objects.create()  
        self.client.post(f'/lists/{correct_list.pk}/add_item'
    ...
    def test_redirects_to_list_view(self):
        ...
        response = self.client.post(f'/lists/{correct_list.pk}/add_item'
                                   ,data={'item_text':"A new item for an existing list"}
                                   )
